(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["hx-account-number"] = factory();
	else
		root["hx"] = root["hx"] || {}, root["hx"]["hx-account-number"] = factory();
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(340)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require('../../components/hx-account-number/hx-account-number.vue'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.hxAccountNumber);
    global.index = mod.exports;
  }
})(this, function (module, exports, _hxAccountNumber) {
  'use strict';
  ...
  var _hxAccountNumber2 = _interopRequireDefault(_hxAccountNumber);
  ...
  _hxAccountNumber2.default.install = function (Vue) {
    Vue.component(_hxAccountNumber2.default.name, _hxAccountNumber2.default);
  };

  exports.default = _hxAccountNumber2.default;
  module.exports = exports['default'];
});
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    ...
    global.hxAccountNumber = mod.exports;
  }
  ...
  exports.default = {
    ...
    methods: {
      formatAccunt: function formatAccunt(accunt) {
        if (!accunt) return '';
        var res = Array.prototype.reduce.call(this.deFormatAccunt(accunt), function (temp, num, i) {
          return temp + num + (i % 4 === 3 ? ' ' : '');
        });

        return res;
      },
      deFormatAccunt: function deFormatAccunt(accunt) {
        return accunt.replace(/\s/g, '');
      },
      inputCheckAccunt: function inputCheckAccunt(accunt) {
        var REGEXP_ACCUNT = /^([1-9]{1})(\d{15}|\d{18})$/;
        var value = this.deFormatAccunt(accunt);
        if (!value) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('hx-input-foundation', {
    ...
    attrs: {
      ...
      "eye": _vm.eye,
      "placeholder": _vm.placeholder,
      "inputCheck": _vm.inputCheckAccunt,
      "errorInfo": _vm.accuntErrorInfo
    },
    on: {
      "input": _vm.handleInput,
      "clickEye": _vm.clickEye
