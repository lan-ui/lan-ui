(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["hx-email"] = factory();
	else
		root["hx"] = root["hx"] || {}, root["hx"]["hx-email"] = factory();
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    ...
    factory(module, exports, require('../../components/hx-email/hx-email.vue'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.hxEmail);
    global.index = mod.exports;
  }
})(this, function (module, exports, _hxEmail) {
  'use strict';
  ...
  var _hxEmail2 = _interopRequireDefault(_hxEmail);
  ...
  _hxEmail2.default.install = function (Vue) {
    Vue.component(_hxEmail2.default.name, _hxEmail2.default);
  };

  exports.default = _hxEmail2.default;
  module.exports = exports['default'];
});
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  var REGEXP_EMAIL = /^([a-z0-9\u4E00-\u9FA5\uFF00-\uFFFF/?^{|}~!#$%&'*+-]+[.]?)*[a-z0-9\u4E00-\u9FA5\uFF00-\uFFFF/?^{|}~!#$%&'*+-]+@([a-z0-9\u4E00-\u9FA5]+[-._~]?)*[a-z0-9\u4E00-\u9FA5]+\.[a-z]{2,6}$/;
  ...
  exports.default = {
    ...
    methods: {
      inputCheckEmail: function inputCheckEmail(val) {
        if (val === '') {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('hx-input-foundation', {
    ...
    attrs: {
      ...
      "disabled": _vm.disabled,
      "placeholder": _vm.placeholder,
      "inputCheck": _vm.inputCheckEmail,
      "errorInfo": _vm.emailErrorInfo
    },
    on: {
      "input": _vm.handleInput
    }
