(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["hx-phoneverification"] = factory();
	else
		root["hx"] = root["hx"] || {}, root["hx"]["hx-phoneverification"] = factory();
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(389)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require('../../components/hx-phoneverification/hx-phoneverification.vue'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.hxPhoneverification);
    global.index = mod.exports;
  }
})(this, function (module, exports, _hxPhoneverification) {
  'use strict';
  ...
  var _hxPhoneverification2 = _interopRequireDefault(_hxPhoneverification);
  ...
  _hxPhoneverification2.default.install = function (Vue) {
    Vue.component(_hxPhoneverification2.default.name, _hxPhoneverification2.default);
  };

  exports.default = _hxPhoneverification2.default;
  module.exports = exports['default'];
});
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    ...
    global.hxPhoneverification = mod.exports;
  }
  ...
  exports.default = {
    ...
    methods: {
      inputCheckVerification: function inputCheckVerification(verification) {
        var value = verification;
        if (!value) {
            this.verificationErrorInfo = '请输入验证码！';
            return false;
          } else if (!REGEXP_VERIFICATION.test(value)) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('hx-input-foundation', {
    ...
    attrs: {
      ...
      "maxlength": _vm.maxlength,
      "placeholder": _vm.placeholder,
      "inputCheck": _vm.inputCheckVerification,
      "errorInfo": _vm.verificationErrorInfo
    },
    on: {
      "input": _vm.handleInput
    }
