(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["hx-address"] = factory();
	else
		root["hx"] = root["hx"] || {}, root["hx"]["hx-address"] = factory();
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(344)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require('../../components/hx-address/hx-address.vue'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.hxAddress);
    global.index = mod.exports;
  }
})(this, function (module, exports, _hxAddress) {
  'use strict';
  ...
  var _hxAddress2 = _interopRequireDefault(_hxAddress);
  ...
  _hxAddress2.default.install = function (Vue) {
    Vue.component(_hxAddress2.default.name, _hxAddress2.default);
  };

  exports.default = _hxAddress2.default;
  module.exports = exports['default'];
});
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  exports.default = {
    ...
    methods: {
      inputCheckAddress: function inputCheckAddress(address) {
        var value = address;
        if (!value) {
            this.addressErrorInfo = '请输入详细地址！';
            return false;
          } else if (!REGEXP_ADDRESS.test(value)) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('hx-input-foundation', {
    ...
    attrs: {
      ...
      "disabled": _vm.disabled,
      "placeholder": _vm.placeholder,
      "inputCheck": _vm.inputCheckAddress,
      "errorInfo": _vm.addressErrorInfo
    },
    on: {
      "input": _vm.handleInput
    }
