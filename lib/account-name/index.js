(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["account-name"] = factory();
	else
		root["lan"] = root["lan"] || {}, root["lan"]["account-name"] = factory();
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(284)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require('../../components/account-name/account-name.vue'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.accountName);
    global.index = mod.exports;
  }
})(this, function (module, exports, _accountName) {
  'use strict';
  ...
  var _accountName2 = _interopRequireDefault(_accountName);
  ...
  _accountName2.default.install = function (Vue) {
    Vue.component(_accountName2.default.name, _accountName2.default);
  };

  exports.default = _accountName2.default;
  module.exports = exports['default'];
});
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    ...
    global.accountName = mod.exports;
  }
  ...
  var REGEXP_ACCUNTNAME1 = /^[\u4e00-\u9fa5]{2,}$/;
  var REGEXP_ACCUNTNAME2 = /^[A-Za-z]{1}[A-Za-z ]{2,}$/;

  exports.default = {
    name: 'lan-account-name',
    components: {
    ...
    methods: {
      inputCheckAccuntName: function inputCheckAccuntName(accuntName) {
        var value = accuntName;
        if (!value || value === ' ') {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('lan-input-foundation', {
    ...
    attrs: {
      ...
      "disabled": _vm.disabled,
      "placeholder": _vm.placeholder,
      "inputCheck": _vm.inputCheckAccuntName,
      "errorInfo": _vm.accuntNameErrorInfo,
      "lanstyle": _vm.lanstyle
    },
    on: {
      "input": _vm.handleInput
